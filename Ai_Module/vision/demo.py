...
demo.py
--------
Command-line demo for the PrepBuddy Vision module.
...
def run_webcam(analyzer: VisionAnalyzer) -> None:
    ...
    while True:
        ...
        cv2.imshow("PrepBuddy Vision Demo", frame)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PrepBuddy Vision module demo")
